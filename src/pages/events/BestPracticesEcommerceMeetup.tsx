...
import MeetupHeroMay21 from '../../components/meetup/MeetupHeroMay21';
...
export default function BestPracticesEcommerceMeetup() {
  ...
  return (
    <div style={FONT} className="pb-20 lg:pb-0">
      <MeetupHeroMay21 formRef={heroFormRef} />
      <MeetupStats />
      <MeetupBenefits />
      <MeetupProgram />
      <MeetupSpeakers />
        ...
        <div className="bg-[#1A1A2E]/95 backdrop-blur-md border-t border-white/10 px-4 py-3">
          <div className="max-w-7xl mx-auto flex items-center justify-between gap-4">
            <p className="text-white/80 text-sm font-medium hidden sm:block truncate">
              Лучшие практики в e-commerce{' '}
              <span className="text-white/40">– 21 мая, Rybakov Tower</span>
            </p>
