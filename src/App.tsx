      ...
      <nav className="fixed top-0 w-full bg-white/95 backdrop-blur-sm border-b border-gray-200 z-50 shadow-sm">
        <div className="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            <div className="flex items-center space-x-1 sm:space-x-4 lg:space-x-6 flex-shrink min-w-0">
            ...
            <a href="#register" className="bg-[#FECE33] text-black px-3 py-2 sm:px-6 sm:py-3 rounded-full hover:bg-[#ffd84d] transition-colors font-bold text-xs sm:text-base whitespace-nowrap flex-shrink-0 ml-1 sm:ml-0">
              РЕГИСТРАЦИЯ
            </a>
          </div>
        </div>
      ...
      <section className="py-20 bg-gradient-to-br from-gray-900 via-black to-gray-900 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          <p className="text-white/60 text-sm mt-6">
            Регистрация закроется накануне мероприятия или при достижении лимита участников
          </p>
        </div>
      </section>
